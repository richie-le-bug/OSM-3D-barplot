...
def overpass_load_points(iso_a2, tag_key='amenity',tag_value='charging_station'):
    ...
    out center;
    """.format(iso_a2, tag_key, tag_value)
...
if __name__ == '__main__':
    iso_a2, tag_key, tag_value = 'SE', 'amenity', 'charging_station'
